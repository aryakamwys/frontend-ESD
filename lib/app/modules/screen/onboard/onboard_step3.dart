...
class OnboardStep3 extends StatelessWidget {
  const OnboardStep3({super.key});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: LinearProgressIndicator(
          value: 1, // Sesuaikan dengan progress step
      ...
      body: Column(
        ...
        children: [
          ...
          Positioned(
            top: 16,
            child: Image.asset(
              'assets/gambar3.png', // Sesuaikan dengan lokasi asset gambar kamu
              width: 1000,
              height: 500,
            ),
          ),
